...
class GestionExport implements FromCollection, WithHeadings, ShouldAutoSize
{
    ...
    public function collection()
    {
        return GestionSolicitudes::select(
            ...
            DB::raw('(select trabajadores.tra_nombre_apellido from trabajadores where trabajadores.id = gestion_solicitudes.idApoyo1) as apoyo1'),
            DB::raw('(select trabajadores.tra_nombre_apellido from trabajadores where trabajadores.id = gestion_solicitudes.idApoyo2) as apoyo2'),
            DB::raw('(select trabajadores.tra_nombre_apellido from trabajadores where trabajadores.id = gestion_solicitudes.idApoyo3) as apoyo3'),
