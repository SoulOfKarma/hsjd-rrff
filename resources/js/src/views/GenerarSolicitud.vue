  ...
  <div>
    ...
    <div class="vx-row">
      <div class="vx-col md:w-1/2 w-full mt-5">
        <h3>Usuario Solicitante : {{ solicitud.nombre }}</h3>
      </div>
    </div>
    <h4>
    ...
    <div class="vx-row">
      <div class="vx-col w-full mt-5">
        ...
        <br />
        <vs-textarea label="Descripcion de la problematica" v-model="solicitud.descripcionP" />
      </div>
    </div>
    ...
    <div class="vx-row">
      <div class="vx-col w-full">
        <vs-button class="mr-3 mb-2" @click="guardarSolicitud">Enviar</vs-button>
  ...
  methods: {
    ...
    guardarSolicitud() {
      if (
        ...
        this.mensajeError = "La descripcion no supera los 15 caracteres";
        ...
        (this.solicitud = {
          ...
          axios
            .post(this.localVal + "/api/Usuario/PostSolicitud", solicitudNueva)
            .then((res) => {
      ...
      axios
        ...
        .then((res2) => {
          if (res2.data.length > 0) {
            ...
            axios
              .post(this.localVal + "/api/Usuario/enviarCorreo", dataCorreo)
              .then((res3) => {
