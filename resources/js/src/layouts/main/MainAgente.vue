...
<template>
  ...
  >
    <v-nav-menu :navMenuItems="navMenuItems" title="AAA" parent=".layout--main" />
...
import HNavMenu from "@/layouts/components/navMenuAgente/horizontal-nav-menu/HorizontalNavMenu.vue";
